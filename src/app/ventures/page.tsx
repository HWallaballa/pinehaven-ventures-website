...
export default function Ventures() {
  const ventures = [
    ...
    },
    {
      id: 'reelpost',
      title: 'ReelPost.ai',
      subtitle: 'AI Video Generation + Multi-Platform Auto-Posting',
      description: 'Generate professional short-form videos with AI and auto-post them to TikTok, YouTube Shorts, Instagram Reels, and Facebook Reels — all from one dashboard. ReelPost handles everything from prompt-to-video generation, multi-platform account management, smart scheduling, and one-click cross-platform posting. Built for creators, agencies, and businesses scaling their short-form video presence.',
      features: [
        'AI video generation from text prompts or pre-built templates',
        'Connect and manage accounts across TikTok, YouTube, Instagram, and Facebook',
        'Cross-platform scheduling with auto-posting at optimal times',
